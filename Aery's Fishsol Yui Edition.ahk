...
if (dev1_name = "ivelchampion249") {
    ...
    dev1_img := A_ScriptDir . "\img\yui2.png"
} else if (dev1_name = "cresqnt") {
    dev1_img := A_ScriptDir . "\img\yui3.png"
}

if (dev2_name = "ivelchampion249") {
    dev2_img := A_ScriptDir . "\img\yui1.png"
} else if (dev2_name = "maxstellar") {
    dev2_img := A_ScriptDir . "\img\yui2.png"
} else if (dev2_name = "cresqnt") {
    dev2_img := A_ScriptDir . "\img\yui3.png"
}

if (dev3_name = "ivelchampion249") {
    dev3_img := A_ScriptDir . "\img\yui1.png"
} else if (dev3_name = "maxstellar") {
    dev3_img := A_ScriptDir . "\img\yui2.png"
...
Gui, Add, Text, x0 y10 w600 h45 Center BackgroundTrans c0x00D4FF, Aery's fishSol vYui
        ...
        if (prevState != "None") {
            ...
            if (auraName = "Equinox" || auraName = "EQUINOX") {
                ...
                if (webResponse = "false") {
                    SendWebhook2(":tada: **Transcendent Detected!** :tada: \nAura detected: " auraName, 0, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuiequinox.gif")
                }
                ...
                ClipCountdownGlobal()
                if (webResponse = "false") {
                    SendWebhook2(":tada: **Transcendent Detected!** :tada: \nAura detected: " auraName, 0, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuibreakthrough.gif")
                }
            } else if (auraName = "Monarch" || auraName = "MONARCH") {
                ClipCountdownGlobal()
                if (webResponse = "false") {
                    SendWebhook2(":tada: **Transcendent Detected!** :tada: \nAura detected: " auraName, 0, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuimonarch.jpg")
                }
                ...
                ClipCountdownGlobal()
                if (webResponse = "false") {
                    SendWebhook2(":tada: **Transcendent Detected!** :tada: \nAura detected: " auraName, 0, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuipixelation.gif")
                }
            ...
            } else if (auraName = "Nyctophobia" || auraName = "NYCTOPHOBIA") {
                ClipCountdownGlobal()
                if (webResponse = "false") {
                    SendWebhook2(" :tada: **Transcendent Detected!** :tada: \nAura detected: " auraName, 11393254, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuinycto.gif")
                }
            } else if (auraName = "CHILLSEAR") {
                ClipCountdownGlobal()
                if (webResponse = "false") {
                    SendWebhook2(" :tada: **Chillsear Detected!** :tada: \nAura detected: " auraName, 11393254, "https://raw.githubusercontent.com/knowaery/Aery-s-Fishsol/main/auracutscenes/yuichillsear.gif")
                }
            }
            if (auraFilter) {
